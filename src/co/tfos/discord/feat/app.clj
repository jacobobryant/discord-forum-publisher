(ns co.tfos.discord.feat.app
  (:require [com.biffweb :as biff :refer [q]]
            [co.tfos.discord.middleware :as mid]
...
(defn notify-clients [{:keys [co.tfos.discord/chat-clients]} tx]
...
(defn ws-handler [{:keys [co.tfos.discord/chat-clients] :as req}]
  {:status 101
